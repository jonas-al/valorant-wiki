        ...
        <div className="flex">
            ...
            <div className="flex flex-col justify-between">
              <div className="flex flex-col gap-y-8">
                <div className="gap-y-2">
                  <h1 className="uppercase font-bold italic text-[118px]">
                    {agent.displayName}
                  </h1>
                ...
                <div className="flex flex-col items-center justify-center text-center gap-y-4 px-12 py-6 rounded-2xl bg-[#080e13] w-fit shadow">
                  ...
                  <div>
                    <h2 className="uppercase font-bold text-2xl block">
                      função
                    </h2>
                    <p className="capitalize text-xl text-[#ff4655] block">
              ...
              <div className="flex flex-col uppercase font-bold text-3xl items-center gap-y-4 h-full">
                ...
                <div className="flex gap-x-6">
                  ...
                  >
                    <div
                      className={`w-full h-full ${
                        selectedSkill === 0 ? "bg-white" : "bg-[#808080]"
                      } `}
                    />
                  </button>
                  <button
                  ...
                  >
                    <div
                      className={`w-full h-full ${
                        selectedSkill === 1 ? "bg-white" : "bg-[#808080]"
                      } `}
                    />
                  </button>
                  <button
                  ...
                  >
                    <div
                      className={`w-full h-full ${
                        selectedSkill === 2 ? "bg-white" : "bg-[#808080]"
                      } `}
                    />
                  </button>
                  <button
                  ...
                  >
                    <div
                      className={`w-full h-full ${
                        selectedSkill === 3 ? "bg-white" : "bg-[#808080]"
                      } `}
                    />
                  </button>
                </div>
                <div className="flex flex-col items-center w-1/2 text-center">
                  <h2 className="uppercase font-semibold text-3xl">
                    {agent.abilities[selectedSkill].displayName}
                  </h2>
                  <p className="uppercase font-medium text-xs">
                    {agent.abilities[selectedSkill].description}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-1/2 overflow-hidden">
            <img
              ...
              className="scale-[1.5] translate-y-32"
            />
          </div>
        </div>
      )}
